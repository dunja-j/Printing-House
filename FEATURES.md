...
| 10a | Prijava da narudžbina nije stigla (umesto potvrde prijema) | 🟡 BONUS | gotovo | Dugme NIJE STIGLO pored POTVRDI PRIJEM (u tabeli narudžbina i u arhivi), uz potvrdu. Status prelazi u `nije_stiglo`, a štampariji raste `broj_nedostavljenih`; posle 3 prijave njeni proizvodi se više ne prikazuju javno (pretraga, TOP 5, kategorije, detalji). Takva stavka izlazi iz arhive pa se proizvod ne može oceniti. |
